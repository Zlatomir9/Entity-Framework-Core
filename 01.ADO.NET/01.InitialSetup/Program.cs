    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            using (dbConnection)
            {
                ...
                ExecuteNonQuery(dbConnection, createDatabase);
                ...
                var insertDataIntoTables = InsertDataStatements();

                foreach (var query in insertDataIntoTables)
                {
                    ExecuteNonQuery(dbConnection, query);
                }
            }
        ...
        private static void ExecuteNonQuery(SqlConnection connection, string querry)
        {
